...
public class ProductsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomAdapter adapter = new CustomAdapter(this,Constants.mProductLine,Constants.mProductLineImages);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(position == 0){
			Intent intent = new Intent(ProductsActivity.this, WheelServiceActivity.class);
			startActivity(intent);
		}
	}
