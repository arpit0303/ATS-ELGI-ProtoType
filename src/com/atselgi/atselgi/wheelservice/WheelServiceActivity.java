...
public class WheelServiceActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomAdapter adapter = new CustomAdapter(this,
				Constants.mProductLine1, Constants.mProductLineImages1);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(position == 0){
			...
			Intent intent = new Intent(WheelServiceActivity.this,
					WheelAlignerActivity.class);
