...
import com.atselgi.atselgi.adapter.CustomAdapter;
import com.atselgi.atselgi.adapter.NavDrawerAdapter;

public class WheelAlignerActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		CustomAdapter adapter = new CustomAdapter(this,
				Constants.mProductLine1_1, Constants.mProductLineImages1_1);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(position == 0){
			Intent intent = new Intent(WheelAlignerActivity.this,
					D3WheelAlignerActivity.class);
			startActivity(intent);
		}
	}
