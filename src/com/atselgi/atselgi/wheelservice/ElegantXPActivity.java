...
import com.atselgi.atselgi.FeaturesFragment;
import com.atselgi.atselgi.ImageFragment;
import com.atselgi.atselgi.R;
import com.atselgi.atselgi.SpecsFragment;
import com.atselgi.atselgi.VideosFragment;
import com.atselgi.atselgi.adapter.NavDrawerAdapter;

public class ElegantXPActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_elegant_xp);
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public int getIcon(int position) {
			switch (position) {
			case 0:
				return R.drawable.images_tab;
			case 1:
				return R.drawable.video_tab;
			case 2:
				return R.drawable.feat;
			case 3:
				return R.drawable.spec;
